...
function preview(opts) {
    ...
    ui = { say: (message) => console.log(message) }, port = 3000, workerFile, assetsDir, publicPath, watch = false, buildWatchPaths, buildCommand, autoReload = false, modules = true, env = {}, } = opts;
